...
export default function AuthScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {/* Header with Logo */}
            <LinearGradient colors={["#E91E63", "#AD1457", "#880E4F"]} style={styles.header}>
                ...
                <ScrollView style={styles.formContainer} showsVerticalScrollIndicator={false}>
                    <Animated.View style={[styles.formContent, { opacity: fadeAnim }]}>
                                ...
                                <View style={styles.inputGroup}>
                                    ...
                                    <View style={styles.inputContainer}>
                                        ...
                                        <TouchableOpacity onPress={() => setShowPassword(!showPassword)} style={styles.eyeIcon}>
                                            <Ionicons name={showPassword ? "eye-outline" : "eye-off-outline"} size={20} color="#7F8C8D" />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            ...
                            <View style={styles.form}>
                                ...
                                <View style={styles.inputGroup}>
                                    ...
                                    <View style={styles.genderContainer}>
                                        ...
                                        >
                                            <Ionicons name="male" size={20} color={formData.gender === "male" ? "white" : "#7F8C8D"} />
                                        ...
                                        >
                                            <Ionicons name="female" size={20} color={formData.gender === "female" ? "white" : "#7F8C8D"} />
                        ...
                        <TouchableOpacity
                            ...
                            disabled={loading}
                        >
                            <LinearGradient colors={["#E91E63", "#AD1457"]} style={styles.submitGradient}>
                                {loading ? (
